  ...
  if (finePointer && !reduced) (function () {
    ...
    if (orb) (function () {
      ...
      function render(t) {
        ...
        shadow.style.transform = "translate3d(" + (pos.x - 115 + vel.x * 0.45).toFixed(2) + "px," + (pos.y + R * 0.61 - Math.max(0, pos.z) * 0.08).toFixed(2) + "px,0) scale(" + sx.toFixed(3) + "," + s2.toFixed(3) + ")";
